...
int main()
{
    ...
    int year, basic_year=1, leap_year, remaining_year, total_days, day;

    printf("Enter the year: ");
    scanf("%d", &year);

    year = year-basic_year-1; //we are calculating the total years between basic year and input year
